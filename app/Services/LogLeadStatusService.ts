...
export default class LogLeadStatusService {
  ...
  async registerLeadLogStatus(id_lead: number, status_primario: Array<number>, status_secundario: Array<number>, user_id: number, mensagem : string | undefined) : Promise<any> {
  ...
  async registerStatusTable( status : Array<number>, id_lead: number,  user_id: number, table : typeof BaseModel,  mensagem: string | undefined = undefined, id_status_primario: number | undefined = undefined ) {
