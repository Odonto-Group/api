...
const PagamentoBoletoService_1 = __importDefault(global[Symbol.for('ioc.use')]("App/Services/PagamentoBoletoService"));
...
let ConfirmacaoPagamentoBoleto = class ConfirmacaoPagamentoBoleto {
    constructor(associadoService, mailSenderService, smsService, pagamentoBoletoService, pagamentoBoletoOdontoCobService) {
    ...
    confirmarPagamento(params, transaction) {
        return __awaiter(this, void 0, void 0, function* () {
            const associado = yield this.associadoService.findAssociadoByNossoNumeroBoleto(params.nossoNumero);
            if (associado && associado.cd_status == 0) {
                const pagamentoOdontoCob = yield this.pagamentoBoletoOdontoCobService.savePagamentoEfetuadoOdontoCob(params.nossoNumero, params, transaction);
                yield this.associadoService.updateAssociadoPagamentoEfetuado(associado, transaction);
                yield this.pagamentoBoletoService.savePagamentoEfetuado(associado, params, pagamentoOdontoCob, transaction);
                ...
                const planoContent = {
                    ...
                    TIPO_PAGAMENTO: FormaPagamento_1.FormaPagamento.BOLETO
                };
...
ConfirmacaoPagamentoBoleto = __decorate([
    ...
    __metadata("design:paramtypes", [AssociadoService_1.default,
        ...
        PagamentoBoletoService_1.default,
        PagamentoBoletoOdontoCobService_1.default])
], ConfirmacaoPagamentoBoleto);
exports.default = ConfirmacaoPagamentoBoleto;
//# sourceMappingURL=ConfirmacaoPagamentoBoleto.js.map