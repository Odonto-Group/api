...
let CompanyPlanController = class CompanyPlanController {
    ...
    index({ params }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let plan;
            if (token) {
                plan = yield this.planService.getPlanWithTokenCompany(state, token, [Category_1.Category.PME_2_29_VIDAS, Category_1.Category.PME_30_199_VIDAS]);
            }
            else {
                plan = yield this.planService.getBasicPlanCompany(state, [Category_1.Category.PME_2_29_VIDAS, Category_1.Category.PME_30_199_VIDAS]);
            }
            return {
    ...
    getPlanDetails({ request }) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.validaToken(token);
            const tokenBanco = yield this.tokenService.findTokenParceiroEmpresa(token);
            ...
            yield Promise.all([
                ...
                TbParentesco_1.default.query().where('nu_UsoTipoPlan', 2),
    ...
    criarDataVencimento() {
        ...
        let nextValue = luxon_1.DateTime.local().plus({ days: 1 }).toFormat('yyyy-MM-dd');
        let nextSelect = luxon_1.DateTime.local().plus({ days: 1 }).toFormat('yyyy/MM/dd');
...
CompanyPlanController = __decorate([
    (0, fold_1.inject)(),
...
exports.default = CompanyPlanController;
//# sourceMappingURL=CompanyPlanController.js.map